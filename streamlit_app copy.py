...
""")
    ...
    for feature_name in input_features:
        ...
        if biomarker_container.checkbox(f'Использовать среднее значение {feature_name}', value=use_avg, key=feature_key + '_avg'):
            ...
            biomarker_container.write(f'Среднее значение для выбранной возрастной группы: {avg_value}')
        else:
            st.session_state[feature_key + '_use_avg'] = False
